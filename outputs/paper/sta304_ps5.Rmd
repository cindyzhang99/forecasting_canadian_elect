...
```{r cesagevote, fig.cap="Distribution of Votes by Age Group in CES.", fig.height=4, echo=FALSE, message=FALSE}
...
```{r postagevote, fig.cap="Distribution of Votes by Age Group in Post-Stratification.", fig.height=4, echo=FALSE, message=FALSE}
